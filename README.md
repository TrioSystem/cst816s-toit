...
swipe-down, swipe-left, swipe-right, single-click, double-click long-press, or at any irq pulse without constantly polling the device.
Optionally all previously registered action are cleared with --clear-all=true 
